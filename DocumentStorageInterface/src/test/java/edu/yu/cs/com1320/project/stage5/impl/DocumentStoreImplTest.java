...
or returned in any form as the result of any “get” or “search” request, or an action on it is undone via any call to either of the DocumentStore.undo methods.
    ...
    @Test
    public void stage5TestReturnToMemoryWithGetText() {
        DocumentStoreImpl store = new DocumentStoreImpl();
        store.setMaxDocumentBytes(this.bytes1 + this.bytes2 + 20);
        store.setMaxDocumentCount(20);
        store.putDocument(new ByteArrayInputStream(this.pdfData1), this.uri1, DocumentStore.DocumentFormat.PDF);
        ...
        assertNotNull("uri3 should still be in memory",store.getDocument(this.uri3));
        assertNotNull("uri4 should still be in memory",store.getDocument(this.uri4));
        assertEquals("uri1 should be back in memory", pdfTxt1, store.getDocumentAsTxt(this.uri1));
        store.getDocumentAsTxt(this.uri2);
        assertNull("uri3 should've been pushed out of memory",store.getDocument(this.uri3));
        assertNull("uri4 should've been pushed out of memory",store.getDocument(this.uri4));
        store.deleteFileFromDisk(uri3);
        store.deleteFileFromDisk(uri4);
    }

    @Test
    public void stage5TestReturnToMemoryWithGetPdf() {
        DocumentStoreImpl store = new DocumentStoreImpl();
        store.setMaxDocumentBytes(this.bytes1 + this.bytes2 + 20);
        store.setMaxDocumentCount(20);
        store.putDocument(new ByteArrayInputStream(this.pdfData1), this.uri1, DocumentStore.DocumentFormat.PDF);
    ...
    @Test
    public void stage5SearchPDFs(){
        DocumentStoreImpl store = new DocumentStoreImpl();
        store.setMaxDocumentBytes(bytes1 + bytes2 + 20);
        store.putDocument(new ByteArrayInputStream(this.pdfData1),this.uri1, DocumentStore.DocumentFormat.PDF);
        store.putDocument(new ByteArrayInputStream(this.pdfData2),this.uri2, DocumentStore.DocumentFormat.PDF);
        store.putDocument(new ByteArrayInputStream(this.pdfData3),this.uri3, DocumentStore.DocumentFormat.PDF);

        List<byte[]> results = store.searchPDFs("pdf");
        assertEquals("expected 3 matches, only received " + results.size(),3,results.size());
        results = store.searchPDFs("missing");
        assertEquals("expected 0 matches, received " + results.size(),0,results.size());
        store.deleteFileFromDisk(uri1);
        store.deleteFileFromDisk(uri2);
    ...
    @Test
    public void stage5SearchByPrefix(){
        DocumentStoreImpl store = new DocumentStoreImpl();
        store.setMaxDocumentCount(2);
        store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        store.putDocument(new ByteArrayInputStream(this.txt2.getBytes()),this.uri2, DocumentStore.DocumentFormat.TXT);
    ...
    @Test
    public void stage5SearchPDFsByPrefix(){
        DocumentStoreImpl store = new DocumentStoreImpl();
        store.setMaxDocumentCount(2);
        store.putDocument(new ByteArrayInputStream(this.pdfData1),this.uri1, DocumentStore.DocumentFormat.PDF);
        store.putDocument(new ByteArrayInputStream(this.pdfData2),this.uri2, DocumentStore.DocumentFormat.PDF);
        ...
        //search, get results
        List<byte[]> results = store.searchPDFsByPrefix("pd");
        assertEquals("expected 2 matches, only received " + results.size(),3,results.size());
        results = store.searchPDFsByPrefix("ado");
        assertEquals("expected 1 match, only received " + results.size(),2,results.size());
        results = store.searchPDFsByPrefix("blah");
        assertEquals("expected 0 match, received " + results.size(),0,results.size());
        store.deleteFileFromDisk(uri2);
    }
    ...
    @Test
    public void stage5DeleteAllWithPrefix(){
        DocumentStoreImpl store = new DocumentStoreImpl();
        store.setMaxDocumentBytes(bytes1 + bytes2 + 20);
        store.putDocument(new ByteArrayInputStream(this.pdfData1),this.uri1, DocumentStore.DocumentFormat.PDF);
        store.putDocument(new ByteArrayInputStream(this.pdfData2),this.uri2, DocumentStore.DocumentFormat.PDF);
    ...
    @Test
    public void stage5TestSearchByKeyword() {
        //put the four docs into the doc store
        DocumentStoreImpl store = new DocumentStoreImpl();
        store.setMaxDocumentCount(2);
        store.putDocument(new ByteArrayInputStream(this.pdfData1), this.uri1, DocumentStore.DocumentFormat.PDF);
    ...
    @Test
    public void stage5TestSearchByPrefix() {
        //put the four docs into the doc store
        DocumentStoreImpl store = new DocumentStoreImpl();
        store.setMaxDocumentCount(2);
        store.putDocument(new ByteArrayInputStream(this.pdfData1), this.uri1, DocumentStore.DocumentFormat.PDF);
    ...
    @Test
    public void stage5TestDeleteAllByKeyword() {
        //put the four docs into the doc store
        DocumentStoreImpl store = new DocumentStoreImpl();
        store.setMaxDocumentBytes(bytes1 + bytes2 + 40);
        store.putDocument(new ByteArrayInputStream(this.pdfData1), this.uri1, DocumentStore.DocumentFormat.PDF);
        store.putDocument(new ByteArrayInputStream(this.pdfData2), this.uri2, DocumentStore.DocumentFormat.PDF);
        store.putDocument(new ByteArrayInputStream(this.pdfData3), this.uri3, DocumentStore.DocumentFormat.PDF);
        store.putDocument(new ByteArrayInputStream(this.pdfData4), this.uri4, DocumentStore.DocumentFormat.PDF);
    ...
    @Test
    public void stage5TestDeleteAllByPrefix() {
        //put the four docs into the doc store
        DocumentStoreImpl store = new DocumentStoreImpl();
        store.setMaxDocumentCount(2);
        store.putDocument(new ByteArrayInputStream(this.pdfData1), this.uri1, DocumentStore.DocumentFormat.PDF);
    ...
    @Test
    public void testDeserializedWordMap(){
        DocumentStoreImpl store = new DocumentStoreImpl();
        store.setMaxDocumentCount(1);
        store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        Map<String, Integer> originalMap = store.getDocument(uri1).getWordMap();
        store.putDocument(new ByteArrayInputStream(this.txt2.getBytes()),this.uri2, DocumentStore.DocumentFormat.TXT);
        assertNull("doc1 should've been deleted",store.getDocument(this.uri1));
        store.getDocumentAsTxt(uri1);
        Map<String, Integer> newMap = store.getDocument(uri1).getWordMap();
        for(String og : originalMap.keySet()){
            assertEquals(originalMap.get(og), newMap.get(og));
        }
        store.deleteFileFromDisk(uri2);
    }
    @Test
    public void testDeserializedWordMapNewBaseDir(){
        DocumentStoreImpl store = new DocumentStoreImpl(new File("C://Testing"));
        store.setMaxDocumentCount(1);
        store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        Map<String, Integer> originalMap = store.getDocument(uri1).getWordMap();
        store.putDocument(new ByteArrayInputStream(this.txt2.getBytes()),this.uri2, DocumentStore.DocumentFormat.TXT);
